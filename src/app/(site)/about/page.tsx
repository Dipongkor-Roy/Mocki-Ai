                    ...
                    <div className="grid md:grid-cols-2 grid-cols-1 justify-center gap-6 pb-16">
                        ...
                        <div className="relative w-full h-[615px] rounded-xl">
                            <Image
                                ...
                                alt="Practicing a mock interview"
                                fill
                        ...
                        <div className="space-y-6">
                            <div className="relative w-full h-[319px] rounded-xl">
                                <Image
                                    ...
                                    alt="Reviewing interview feedback"
                                    fill
                                    sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                                    className="object-cover rounded-xl"
                                    priority
                            ...
                            <div className="w-full" data-aos="fade-up" data-aos-duration="400" data-aos-delay="0">
                                <div className="font-dm bg-cyan-gradient rounded-xl p-6 h-[275px] flex flex-col dark:bg-image-none dark:bg-gray-800">
                                    ...
                                    <div className="mt-auto">
                                        <h3 className="text-gray-900 font-medium mb-1 text-[75px] leading-none">9</h3>
                    ...
                    <div className="grid md:grid-cols-2 grid-cols-1 justify-center gap-6">
                        <div className="w-full">
                            <h3 className="text-gray-900 font-semibold lg:text-[34px] leading-tight text-2xl lg:w-5/6 tracking-tight">
                                I built this because reading interview tips never calmed my nerves
                            </h3>
                        </div>
                        <div className="w-full space-y-6">
                            <p className="text-gray-600 text-[17px] font-medium max-w-xl lg:pr-8 px-0" data-aos="fade-up" data-aos-duration="300">
                                Every guide says the same thing: practice out loud. But there was never anywhere to
                                actually do that on demand — so I built Mocki AI. You get a set of real interview
                                questions tailored to your CV and target role, answer them with your own voice and
                                camera, and get honest AI feedback on how you actually sounded.
                            </p>
                            <p className="text-gray-600 text-[17px] font-medium max-w-xl lg:pr-8 px-0" data-aos="fade-up" data-aos-duration="300">
                                It&apos;s a personal project, not a company — free to use, with no signup paywall
                                and no sales pitch. Just a way to rehearse the real thing before it matters.
                            </p>
                            <div data-aos="fade-up" data-aos-delay="200" data-aos-duration="400">
                                <Button href="/dashboard" label="Try a mock interview" bgColor="bg-blue-600" textColor="text-white" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-screen-xl mx-auto px-3 sm:px-6 md:px-14 lg:px-14 xl:px-18 2xl:px-4 lg:py-24 py-20">
                    ...
                    <div className="grid md:grid-cols-3 grid-cols-1 gap-6">
                        <div className="p-6 rounded-xl border border-gray-100 bg-white">
                            <h4 className="text-base font-semibold text-gray-900 mb-2">Voice-first, always</h4>
                            <p className="text-gray-600 text-sm leading-relaxed">
                                Typing an answer trains a different skill than speaking one. Every question here is
                                answered out loud, because that&apos;s what the real interview will demand.
                            </p>
                        </div>
                        <div className="p-6 rounded-xl border border-gray-100 bg-white">
                            <h4 className="text-base font-semibold text-gray-900 mb-2">Feedback, not just a score</h4>
                            <p className="text-gray-600 text-sm leading-relaxed">
                                A number alone doesn&apos;t help you improve. Every report breaks down strengths,
                                gaps, and specific per-question feedback you can act on.
                            </p>
                        </div>
                        <div className="p-6 rounded-xl border border-gray-100 bg-white">
                            <h4 className="text-base font-semibold text-gray-900 mb-2">Free, no catch</h4>
                            <p className="text-gray-600 text-sm leading-relaxed">
                                This is a personal project, not a SaaS. No paywall, no trial countdown — just a
                                place to practice before the interview that actually matters.
                            </p>
                        </div>
                    </div>
                </div>
