        ...
        <div className="max-w-screen-xl mx-auto px-3 sm:px-6 md:px-14 lg:px-14 xl:px-18 2xl:px-3">
          <div className="flex flex-col lg:py-5 lg:w-1/2 w-full mx-auto">
            ...
            <div className="mx-auto">
              <h1 className="lg:text-4xl text-2xl text-center pt-6 font-semibold lg:px-10 text-gray-900">
                We are under construction, check back for an update soon.
              </h1>
              <p className="text-gray-800 font-medium text-lg leading-7 text-center mt-4 lg:px-10 pb-4">
                Oops, the page you are trying to access does not exist ? Try
                again later or go back to home
              </p>
