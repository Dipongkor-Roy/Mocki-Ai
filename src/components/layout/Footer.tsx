...
export default function Footer({
  layout = "default",
  foretextColor = "text-white",
  logo = "/images/logo/logo-white.png",
  borderColor = "border-gray-800",
  bgColor = "bg-gray-900",
  foreColor = "bg-blue-600",
  ...
  return (
    <footer
      className={`font-dm relative z-10 footer-wrap text-gray-100 ${bgColor} ${layout}-layout`}
    >
      <div className="max-w-screen-xl mx-auto px-3 sm:px-6 md:px-14 lg:px-14 xl:px-18 2xl:px-3 pb-0">
        ...
        {layout === "default" || layout === "light" ? (
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 footer-wrap-top lg:py-14 py-8">
            ...
            <div className="flex flex-col gap-3 w-full lg:max-w-md">
              <Link href="/" className="flex items-center">
                ...
                />
                <h2 className="ml-2 text-xl font-semibold text-white dark:text-black">
                  {brandName}
                </h2>
              </Link>
              <p
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 grid-cols-1 gap-6 footer-wrap-top lg:py-14 py-6">
            ...
            <div className="flex flex-row gap-3 items-center w-full">
              ...
              <div>
                <p className="text-2xl font-semibold mb-0">chat@uitheme.shop</p>
                <p className="text-base font-medium text-gray-400">
                  Chat with our team
                </p>
              </div>
          ...
          <div className="flex flex-wrap gap-y-4 footer-wrap-top lg:py-14 py-6">
            ...
            <div className="w-full xl:w-1/3">
              <div className="flex flex-col sm:flex-row gap-3 mt-2 mb-4">
                ...
                />
                <button
                  className={`px-6 py-3 rounded-md transition ${foretextColor} ${foreColor} ${hoverClass}`}
                >
                  Subscribe
                </button>
              </div>
        ...
        {/* Newsletter + Links */}
        <div
          className={`${layout === "elegant" ? "" : "grid lg:grid-cols-2 lg:gap-24 gap-y-16"} footer-wrap-content`}
        >
          {/* Newsletter */}
          {layout === "default" || layout === "light" ? (
                  ...
                  <li>
                    <Link href="#" aria-label="facebook">
                      <svg
                        ...
                        height="20"
                        fill="currentColor"
                        className={`${layout === "light" ? "text-gray-900" : layout === "default" ? "text-gray-300" : ""}`}
                        viewBox="0 0 16 16"
                      >
            ...
            <div
              className={`${layout === "modern" ? "" : "lg:border-r"} border-gray-800 max-w-md`}
            >
              {/* Logo */}
              ...
              <p
                className={`${layout === "modern" ? "text-gray-800" : "text-gray-400"} mt-5`}
              >
                ...
                <ul className="flex gap-2 mt-5">
                  <li>
                    <a
                      href="#"
                      aria-label="gitlab"
                      className={`${layout === "modern" ? "text-gray-700 hover:bg-gray-700 bg-gray-200" : "text-white hover:bg-gray-700 bg-gray-800"} rounded-full w-12 h-12 text-center flex items-center justify-center transition`}
                    >
                      <GitBranch size={24} />
                    </a>
                  </li>
          ...
          {layout === "elegant" ? (
            <div className="grid lg:grid-cols-5 md:grid-cols-3 grid-cols-2 gap-y-8">
              <div>
                ...
                <ul
                  className={`text-gray-900 footer-link flex flex-col gap-3 text-sm`}
                >
                  <li>
        ...
        {layout === "elegant" ? (
          <>
            <div className="flex lg:flex-row flex-col justify-between gap-y-6 lg:py-8 py-6">
              <div className="">
                <p className="text-gray-800 text-base font-medium lg:text-start text-center">
            ...
            <span className="lg:text-[225px] text-9xl font-black leading-[0.7] mb-0 tracking-[-10px] bg-gradient-to-b from-[#EAEAEA] to-transparent bg-clip-text text-transparent">
              Productivity
            </span>
          </>
        ) : (
