...
const Header = ({
  ...
  return (
    <header
      className={`header-wrapper w-full ${position} left-0 z-50 transition-all duration-300 ease-in-out font-dm-sans ${headerClass === "bg-color-none" ? "bg-color-none top-0" : ""} ${theme} ${
        scrolled ? "scroll-header shadow-xs" : `${bgColor} border-transparent`
      }`}
    >
